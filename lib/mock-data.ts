...
export const INITIAL_SUPERSTORES: Superstore[] = [
  {
    id: "store-001",
    branchName: "Magozi Dark Store - Indiranagar",
    openStatus: "OPEN",
    rating: 4.9,
    distanceKm: 1.2,
    fullAddress: "Plot 104, 100 Feet Road, Indiranagar, Bengaluru",
    imageUrl: "https://images.unsplash.com/photo-1578916171728-46686eac8d58?auto=format&fit=crop&w=600&q=80"
  },
  {
    id: "store-002",
    branchName: "Magozi Express Hub - Koramangala",
    openStatus: "OPEN",
    rating: 4.8,
    distanceKm: 2.5,
    fullAddress: "80 Feet Road, 6th Block, Koramangala, Bengaluru",
